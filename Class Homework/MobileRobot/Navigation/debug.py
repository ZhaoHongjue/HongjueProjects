...
class Debugger(object):
    ...
    def draw_all_Vor(self, sample_x, sample_y, path_x, path_y):
        package = Debug_Msgs()
        self.draw_points(package, sample_x, sample_y)
        self.draw_finalpath(package, path_x, path_y)
        self.sock.sendto(package.SerializeToString(), self.debug_address)
    
    def draw_all_PRM(self, sample_x, sample_y, road_map, path_x, path_y):
        package = Debug_Msgs()
        self.draw_points(package, sample_x, sample_y)
    ...
    def draw_all_RRT(self, path_x, path_y, robot_x, robot_y):
        package = Debug_Msgs()
